                        ...
                        <div id="primary" class="content-area">
                            <main id="main" class="site-main">
                                <div class="homev6-slider-with-banners row">
                                    ...
                                    <h4 style="text-align: center;">Chọn tài liệu theo hãng trong danh sách</h4>
                                <div style="padding-left: 28%;">
                                 <form action="" method="GET" class="form-inline" role="form" width="120px">
                                ...
                                <section class="section-products-carousel" id="homev6-carousel-3">
                                    <header class="section-header"> 
                                        <h2 class="section-title">Tìm thấy {{count($cats)}} tài liệu</h2>
                                                 ...
                                                 @foreach($cats as $cat)
                                                        <div class="product"> 
                                                            <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                <img src="{{url('uploads/download')}}/{{$cat->cover_image}}" class="wp-post-image img-responsive " alt="">
                                                                  <span class="price">
                                                                    <ins>
                                                            ...
                                                            <h2 class="woocommerce-loop-product__title"> Danh mục: {{$cat->category->title}}</h2>
                                                            </a>
                                                            <div class="hover-area">
                                                                <a class="button add_to_cart_button" href="{{route('view_doc',[
                                                                'slug'=>$cat->slug])}}" rel="nofollow">Xem chi tiết</a>   
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                 <!-- /.product-outer -->
                                                        ...
                                                        <div class="woocommerce">
                                                            <div class="products">
                                                                 @foreach($catalog as $cata)
                                                                    <div class="product"> 
                                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                            <img src="{{url('uploads/download')}}/{{$cata->cover_image}}" class="wp-post-image img-responsive " alt="">
                                                                              <span class="price">
                                                                                <ins>
                                                                                    <span class="amount"> </span>
                                                                                </ins>
                                                                        ...
                                                                        <h2 class="woocommerce-loop-product__title"> Danh mục: {{$cata->category->title}}</h2>
                                                                        </a>
                                                                        <div class="hover-area">
                                                                            <a class="button add_to_cart_button" href="{{route('view_doc',[
                                                                'slug'=>$cata->slug])}}" rel="nofollow">Xem chi tiết</a>   
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                                    <!-- /.product-outer --> 
                                                        ...
                                                        <div class="woocommerce">
                                                            <div class="products">
                                                                 @foreach($pricelist as $price)
                                                                    <div class="product"> 
                                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                            <img src="{{url('uploads/download')}}/{{$price->cover_image}}" class="wp-post-image img-responsive " alt="">
                                                                              <span class="price">
                                                                                <ins>
                                                                                    <span class="amount"> </span>
                                                                                </ins>
                                                                        ...
                                                                        <h2 class="woocommerce-loop-product__title"> Danh mục: {{$price->category->title}}</h2>
                                                                        </a>
                                                                        <div class="hover-area">
                                                                            <a class="button add_to_cart_button" href="{{route('view_doc',[
                                                                'slug'=>$price->slug])}}" rel="nofollow">Xem chi tiết</a>   
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                                    <!-- /.product-outer --> 
                                                        ...
                                                        <div class="woocommerce">
                                                             <div class="products">
                                                                 @foreach($manuals as $manua)
                                                                    <div class="product"> 
                                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                            <img src="{{url('uploads/download')}}/{{$manua->cover_image}}" class="wp-post-image " alt="">
                                                                              <span class="price">
                                                                                <ins>
                                                                                    <span class="amount"> </span>
                                                                                </ins>
                                                                        ...
                                                                        <h2 class="woocommerce-loop-product__title"> Danh mục: {{$manua->category->title}}</h2>
                                                                        </a>
                                                                        <div class="hover-area">
                                                                            <a class="button add_to_cart_button" href="{{route('view_doc',[
                                                                'slug'=>$manua->slug])}}" rel="nofollow">Xem chi tiết</a>   
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                                    <!-- /.product-outer --> 
                                                        ...
                                                        <div class="woocommerce">
                                                             <div class="products">
                                                                 @foreach($software as $soft)
                                                                    <div class="product"> 
                                                                        <a href="single-product-fullwidth.html" class="woocommerce-LoopProduct-link">
                                                                            <img src="{{url('uploads/download')}}/{{$soft->cover_image}}" class="wp-post-image " alt="">
                                                                              <span class="price">
                                                                                <ins>
                                                                                    <span class="amount"> </span>
                                                                                </ins>
                                                                        ...
                                                                        <h2 class="woocommerce-loop-product__title"> Danh mục: {{$soft->category->title}}</h2>
                                                                        </a>
                                                                        <div class="hover-area">
                                                                            <a class="button add_to_cart_button" href="{{route('view_doc',[
                                                                'slug'=>$soft->slug])}}" rel="nofollow">Xem chi tiết</a>   
                                                                        </div>
                                                                    </div>
                                                                @endforeach
                                                                    <!-- /.product-outer --> 
